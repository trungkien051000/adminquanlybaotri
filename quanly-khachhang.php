...
<td>
<a href="sua-khachhang.php?idkh=<?php echo htmlentities($result->MaKhachHang);?>"><i class="fa fa-edit" title="Chỉnh sửa"></i> </a> 
<a href="deletekh.php?idkh=<?php echo htmlentities($result->MaKhachHang);?>" onclick="return confirm('Bạn có muốn xóa ?');" ><i class="fa fa-trash-o" title="Xóa"></i> </a> 
</td>
</tr>
<?php $cnt=$cnt+1;}} ?>
